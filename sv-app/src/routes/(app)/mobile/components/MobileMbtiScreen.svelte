<script lang="ts">
	import { dimensions } from '../mobile.constants';
	import type { MbtiLetter, MbtiSelection, MobileCardGradient } from '../mobile.types';
	import MobileMbtiCard from './MobileMbtiCard.svelte';
