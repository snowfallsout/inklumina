<script lang="ts">
  import { displayState, displaySessionPanelOpen } from '$lib/display/state';
  import { createDisplaySession, deleteDisplaySession, regenerateJoinQr, viewDisplaySession } from '$lib/display/session/client';
